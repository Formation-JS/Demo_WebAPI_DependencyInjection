...
export class ProductController {
  ...
  constructor(@inject(IOC_TYPES.ProductService) private productService: IProductService) {}
  ...
  @Get('/:id')
  public async GetById(@Path() id: string): Promise<Product> {
    return await this.productService.getById(id);
  }

  @Post()
  public async Add(@Body() productData: ProductDto): Promise<Product> {
